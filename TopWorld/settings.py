"""
Django settings for TopWorld project.
...
SECRET_KEY = 'django-insecure-goh4!@4(4)r)sfe^l22om9(ro8%u^agtf&h%ztff90mesh2cpk'
...
WSGI_APPLICATION = 'TopWorld.wsgi.application'
